#Added comments to quickly refer to what the code does
#tkraise is used to swtich frames as I said in the testing log I wanted to change pages within one window.
